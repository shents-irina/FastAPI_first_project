...
@router.get(path="", summary="Получение данных доступных отелей")
...
async def create_hotel(
    ...
    hotel_data: HotelAdd = Body(
        openapi_examples={
            "1": {
                "summary": "Сочи",
                "value": {"title": "Отель у моря", "location": "г. Сочи, ул. Морская, 1"},
            },
            "2": {
                "summary": "Дубай",
                "value": {"title": "Отель у фонтана", "location": "г. Дубай, ул. Шейха, 2"},
            },
        }
    ),
):
